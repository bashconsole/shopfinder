...
namespace Bashconsole\Shopfinder\Model\ResourceModel;
...
class Stores extends AbstractDb
{
    ...
    {
        $this->_init('bashconsole_shopfinder_stores', 'entity_id');
    }

    /**
     * Process shop data before deleting
     *
    ...
    public function _beforeDelete(AbstractModel $object)
    {
        ...
        $this->getConnection()->delete($this->getTable('bashconsole_shopfinder_stores'), $condition);
     ...
     *
     * @param AbstractModel|\Bashconsole\Shopfinder\Model\Stores $object
     * @return $this
     */
